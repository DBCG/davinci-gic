...
2. Docker Container:
        ...
        R4
        ```
        docker pull contentgroup/cqf-ruler:gic-testing
        docker run -p 8080:8080 contentgroup/cqf-ruler:gic-testing
        ```
3. Code repository:
...
A Postman collection containing all the content required for the Sessions can be downloaded from: https://github.com/DBCG/davinci-gic/blob/master/fhir401/docs/postman-collection/Connectathon%2027%20DEQM-GIC.postman_collection.json
...
NOTE: The Postman Collection contains variables.  As environment variables may conflict, set No Environment.
